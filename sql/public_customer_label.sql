...
SELECT
    ...
    GREATEST(COALESCE(future_value.signed_revenue, 0), 0) AS future_net_revenue_180d,
    CAST(GREATEST(COALESCE(future_value.signed_revenue, 0), 0) > 0 AS INTEGER) AS future_active_180d
